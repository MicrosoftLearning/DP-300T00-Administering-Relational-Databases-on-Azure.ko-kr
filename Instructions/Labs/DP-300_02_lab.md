...
4. 다음 입력으로 SQL Database 기본 화면 만들기를 완료한 후 **다음: 네트워킹을 클릭합니다.**
    ...
    -  컴퓨팅 + 스토리지: **데이터베이스 구성**을 클릭합니다.
		...
		- 구성 화면의 서비스 계층 드롭다운에서 **기본**을 선택합니다.
...
11. **다음: 보안** 단추를 클릭합니다. 기본값 **나중에** _SQL에 대해 Azure Defender 사용_을 그대로 유지합니다. 그 후 **다음: 추가 설정** 단추를 클릭합니다.  
...
2. Azure 서비스에 대한 액세스 허용을 **예**로 밉니다.  **+ 클라이언트 IP 추가**를 클릭한 다음 **저장**을 클릭합니다.  
‎
	![그림 50](../images/dp-3300-module-22-lab-40.png)

3. 저장한 후 오른쪽 위에 있는 **클라이언트 IP 추가** 단추를 다시 클릭하여 클라이언트 IP를 방화벽에 추가합니다.
